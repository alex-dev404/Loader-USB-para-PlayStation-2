...
<ol>
    ...
    <li>Crie a Pasta <strong>BOOT</strong> no <strong>PENDRIVE</strong> e Coloque o <strong>OPL</strong> dentro seguindo este caminho <strong>mass0:/BOOT/OPL.ELF</strong>.</li>
</ol>
